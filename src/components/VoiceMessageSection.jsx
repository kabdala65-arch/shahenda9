...
export default function VoiceMessageSection() {
  ...
  // نسجّل الرسالة الصوتية عند منسّق الصوت عشان توقف الموسيقى
  // تلقائي وقت ما تتشغل، وترجع تشتغل تاني بعد ما تخلص.
  useEffect(() => {
    const unregister = registerMedia('voice', {
  ...
  useEffect(() => {
    ...
    if (!audio) return
    const onPlay = () => notifyPlaying('voice')
    const onPause = () => notifyStopped('voice')
  ...
  return (
    <section className="voice-section">
      ...
      >
        ...
        <h2 className="section-title">اسمعي صوتي شوية</h2>
